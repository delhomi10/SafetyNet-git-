...
import 'package:abdelhomi/src/chat_ui/my_message_card.dart';
import 'package:abdelhomi/src/chat_ui/reply_card.dart';
import 'package:abdelhomi/src/model/ChatModel.dart';
import 'package:abdelhomi/src/model/message_model.dart';
                              ...
                              Padding(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: IconButton(
                                    icon: Icon(
                                       Icons.send,
                                      color: sendButton ?Colors.white:Colors.grey,
                                    ),
                                    onPressed: () {
                                      if (sendButton) {
